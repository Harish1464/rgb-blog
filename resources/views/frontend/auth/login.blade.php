                     ...
                     <div class="col-md-10">
                        <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                           <div class="card-body">
                              ...
                              <p class="text-center">User Login to stay connected.</p>
                              ...
                              <form method="post" action="{{route('user-login')}}">
                                 ...
                                 <div class="d-flex justify-content-center">
                                    <button type="submit" class="col-lg-12 btn btn-primary">Sign In</button>
                                 </div>
                                    <a href="{{route('user-register-form')}}">Register as New User?</a>
                              </form>
                           </div>
                        </div>
                     </div>
