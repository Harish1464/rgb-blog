                            ...
                            @isset($blogs)
                                @foreach($blogs as $blog)
                                    <tr>
                                       ...
                                       <td>{{$blog->name}}</td>
                                       <td>{{$blog->blogCategory[0]->category->name}}</td>
                                       <td>{{$blog->blogTag[0]->tag->name}}</td>
                                       <td>
                                            <img src="{{ asset('storage/blog/'.$blog->images[0]->path) }}" alt="Image" loading="lazy" style="border: 1px solid #eaeaea; width:50px; height: 50px;">
                                       </td>
                                       <td>{{$blog->slug}}</td>
                                       <td>
                                            <a href="{{route('blog.edit', $blog->slug)}}" class="btn btn-primary btn-sm" title="Edit Blog"> 
                                            ...
                                            <form action="{{route('blog.delete', $blog->slug)}}" method="delete"></form> 
                                       </td>
                                    </tr>
                                @endforeach
                            @endisset
