...
@section('title') Tag List @endsection
                            ...
                            @isset($tags)
                                @foreach($tags as $tag)
                                    <tr>
                                       ...
                                       <td>{{$tag->slug}}</td>
                                       <td>
                                            <a href="{{route('tag.edit', $tag->slug)}}" class="btn btn-primary btn-sm" title="Edit Tag"> 
                                            ...
                                            <form action="{{route('tag.delete', $tag->slug)}}" method="delete"></form> 
                                       </td>
                                    </tr>
                                @endforeach
                            @endisset
